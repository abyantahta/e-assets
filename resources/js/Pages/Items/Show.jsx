                                            ...
                                            {(transactions.data).map((transaction, index) => {
                                                return (
                                                    <tr className="min-w-full flex text-center gap-3 mt-3" key={transaction.id}>
                                                        ...
                                                        <td className={`${index % 2 != 0 ? "bg-green-50" : "bg-white"} px-3 h-11 py-2 text-ellipsis overflow-hidden text-nowrap text-center border-greenTheme border-2 rounded-[0.25rem] w-32`}>{transaction.location_id.location_name}</td>
